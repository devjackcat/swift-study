...
@IBDesignable
public class IBCornerRadiusMasksView: UIView {
    ...
    @IBInspectable var maskTopLeft: Bool = true
    @IBInspectable var maskTopRight: Bool = true
    @IBInspectable var maskBottomLeft: Bool = true
    @IBInspectable var maskBottomRight: Bool = true
