...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/Cache-iOS13.1/Cache.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Closures-iOS13.1/Closures.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/GzipSwift-iOS13.1/Gzip.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/HandyJSON-iOS13.1/HandyJSON.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/IGListDiffKit-iOS13.1/IGListDiffKit.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/RxRelay-iOS13.1/RxRelay.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/RxSwift-iOS13.1/RxSwift.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SnapKit-iOS13.1/SnapKit.framework"
